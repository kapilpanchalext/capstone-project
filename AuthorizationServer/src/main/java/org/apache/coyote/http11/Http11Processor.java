...
//    	printFieldValues(request);
//    	printFieldValues(response);
...
//    public static void printFieldsRecursive(Object obj, String indent) {
//        if (obj == null) {
//            System.out.println(indent + "null");
//            return;
//        }
//
//        // Avoid infinite recursion for already visited objects (circular references)
...
//        visited.add(obj);
//
//        // Print primitives, wrappers, and strings directly
...
//        System.out.println(indent + "Class: " + clazz.getName());
//
...
//                            printFieldsRecursive(entry.getValue(), indent + "    ");
//                        }
//                    } else if (value instanceof List) {
//                        System.out.println("List:");
//                        for (Object item : (List<?>) value) {
//                            printFieldsRecursive(item, indent + "    ");
//                        }
...
//                        }
//                    } else {
//                        printFieldsRecursive(value, indent + "    ");
//                    }
//                } catch (IllegalAccessException e) {
//                    System.err.println(indent + "  Cannot access field: " + field.getName() + " (" + e.getMessage() + ")");
//                } catch (Exception e) {
//                    System.err.println(indent + "  Error processing field: " + field.getName() + " (" + e.getMessage() + ")");
//                }
//            }
