...
public class Http11OutputBuffer implements HttpOutputBuffer {
	...
	public String toString() {
		return "Http11OutputBuffer [response=" + response + ", ackSent=" + ackSent + ", responseFinished="
				+ responseFinished + ", headerBuffer=" + headerBuffer + ", filterLibrary="
				+ Arrays.toString(filterLibrary) + ", activeFilters=" + Arrays.toString(activeFilters)
				+ ", lastActiveFilter=" + lastActiveFilter + ", outputStreamOutputBuffer=" + outputStreamOutputBuffer
				+ ", socketWrapper=" + socketWrapper + ", byteCount=" + byteCount + "]";
	}
}
